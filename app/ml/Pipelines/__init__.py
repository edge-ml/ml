...
from ml.Pipelines.AutoMLClassificationPipeline import AutoMLClassificationPipeline
from ml.Pipelines.ManualClassificationPipeline import ManualClassificationPipeline
...
_pipelineOptions = load_modules("./ml/Pipelines/", AbstractPipelineOption)
