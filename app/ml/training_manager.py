...
class TrainingManager:
    ...
    def start(self, t: Trainer):
        ...
        print("PHASE 1")
        initiate_training = self.pool.schedule(t.get_df_labeled_each_dataset, timeout=50)
        print('PHASE 1 SEC')
        try:
        ...
        feature_extraction = self.pool.schedule(t.feature_extraction, args=[df_labeled_each_dataset], timeout=50)
        try:
        ...
        training = self.pool.schedule(t.train, args=[data_x, data_y], timeout=50)
        try:
